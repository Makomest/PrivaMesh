    ...
    private var slides: [SlideData] {[
        ...
        SlideData(
            ...
            points: [
                ...
                PointData(icon: "fuelpump.fill",
                          color: Color(red: 99/255, green: 102/255, blue: 241/255),
                          text: "**Газ-кошелёк** — комиссии платит отдельный кошелёк, твой адрес скрыт"),
        ...
        SlideData(
            ...
            badge: "~$0.0003",
            title: "Зачем\nплатить?",
            subtitle: "Сообщение — это транзакция в блокчейне. Стоит в ~1000 раз дешевле SMS.",
            points: [
                PointData(icon: "dollarsign.circle.fill",
                          color: Color(red: 245/255, green: 158/255, blue: 11/255),
                          text: "~**$0.0003** за сообщение = $0.30 за 1000 сообщений"),
                PointData(icon: "server.rack",
                          color: Color(red: 99/255, green: 102/255, blue: 241/255),
                          text: "**Вместо абонплаты** серверам, которые следят за тобой"),
