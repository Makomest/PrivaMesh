                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 14) {
                        ...
                        clause("Сквозное шифрование",
                               "Сообщения зашифрованы end-to-end и хранятся не на наших серверах. Разработчик НЕ имеет доступа к их содержимому.")
                        clause("Самостоятельное хранение",
                               "Ты единолично контролируешь свою фразу восстановления. Потеря фразы = потеря доступа к аккаунту. Разработчик не может восстановить аккаунт.")
